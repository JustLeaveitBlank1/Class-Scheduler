...
class MeetingTime(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    code = Column(String, unique=True, nullable=False) # e.g., 1400TU
    description = Column(String, nullable=False) # e.g., "Tue/Thu 2:00-3:15 PM"

    assignments = relationship("Assignment", back_populates="meeting_time")
...
class Assignment(Base):
    ...
    meeting_time = relationship("MeetingTime", back_populates="assignments")
